...
const CORE_STATIC_PATHS = new Set([
  ...
  '/calculator/off-grid-solar/guide/',
  '/calculator/off-grid-solar/guide/12v-vs-24v-vs-48v-rv-solar/',
  '/calculator/off-grid-solar/guide/how-many-solar-panels-for-camper-van/',
  '/calculator/off-grid-solar/guide/lifepo4-battery-size-rv-solar/',
  '/calculator/off-grid-solar/guide/mppt-charge-controller-sizing-rv-solar/',
  '/calculator/off-grid-solar/guide/portable-vs-roof-solar-panels-rv/',
  '/calculator/off-grid-solar/guide/rv-solar-inverter-size-guide/',
  '/calculator/off-grid-solar/guide/rv-solar-buying-checklist/',
  '/calculator/off-grid-solar/guide/rv-solar-wiring-and-fuse-checklist/',
  '/docker/',
